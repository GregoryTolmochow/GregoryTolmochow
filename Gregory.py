def gameintro():
    ...
    time.sleep(2)
    print('If you dare to play you will be put up against the ultimate test, risking you age for success')
    time.sleep(2)
    y = input('Enter your age: ')
    time.sleep(2)
    print('Hahahahahahahah, I hope you have just realized you have done')
    time.sleep(2)
